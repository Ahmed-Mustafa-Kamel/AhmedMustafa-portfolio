            ...
            <div className="flex items-center gap-2 mt-auto fade-in">
              {socialLinks.map(({ href, icon }, index) => (
                <a
                  ...
                  href={href}
                  target="_blank"
                  className=" w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[bacground-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                >
                  {icon}
                </a>
              ))}
